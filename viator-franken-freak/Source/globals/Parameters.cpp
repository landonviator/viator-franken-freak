...
void ViatorParameters::Params::initSliderParams()
{
    ...
    // osc 1
    _sliderParams.push_back({ViatorParameters::osc1TimbreID, ViatorParameters::osc1TimbreName, -10.0f, 10.0f, 0.0f, skew::kNoSkew, 0.0, type::kFloat});
    ...
    _osc1SliderParams.push_back({ViatorParameters::osc1TimbreID, ViatorParameters::osc1TimbreName, -10.0f, 10.0f, 0.0f, skew::kNoSkew, 0.0, type::kFloat});
    ...
    // osc 2
    _sliderParams.push_back({ViatorParameters::osc2TimbreID, ViatorParameters::osc2TimbreName, -10.0f, 10.0f, 0.0f, skew::kNoSkew, 0.0, type::kFloat});
    ...
    _osc2SliderParams.push_back({ViatorParameters::osc2TimbreID, ViatorParameters::osc2TimbreName, -10.0f, 10.0f, 0.0f, skew::kNoSkew, 0.0, type::kFloat});
    ...
    _sliderParams.push_back({ViatorParameters::arpOctaveID, ViatorParameters::arpOctaveName, 1.0f, 3.0f, 1.0f, skew::kNoSkew, 0.0, type::kInt});
    ...
    _arpSliderParams.push_back({ViatorParameters::arpOctaveID, ViatorParameters::arpOctaveName, 1.0f, 3.0f, 1.0f, skew::kNoSkew, 0.0, type::kInt});
}

void ViatorParameters::Params::initButtonParams()
{
    _buttonParams.push_back({ViatorParameters::osc1PowerID, ViatorParameters::osc1PowerName, true});
    _buttonParams.push_back({ViatorParameters::osc2PowerID, ViatorParameters::osc2PowerName, true});
    _buttonParams.push_back({ViatorParameters::modPowerID, ViatorParameters::modPowerName, false});
