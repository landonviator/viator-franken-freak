...
namespace BinaryData
{
    ...
    const int            menu_pngSize = 32849;

    extern const char*   menu_open_png;
    const int            menu_open_pngSize = 23984;
    ...
    extern const char*   text_box_png;
    const int            text_box_pngSize = 13005;
